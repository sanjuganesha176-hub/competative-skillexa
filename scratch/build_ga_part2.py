# scratch/build_ga_part2.py
# Generates ga_part2.py for Topics 56 to 58:
# 56: Economy
# 57: Static GK
# 58: Awards and Honours
        ...
        "rules": [
            {
                ...
                "words": ["Net = Gross - Depreciation", "Market Price = Factor Cost + NIT", "National Income = NNP at FC"],
            ...
            },
            {
                ...
                "words": ["Fight Inflation", "Hike Repo Rate", "Increase CRR", "Contract Liquidity"],
            ...
            },
            {
                ...
                "words": ["Stagflation", "Stagnant Growth + High Unemployment + High Inflation", "Defies Phillips Curve"],
            ...
            },
            {
                ...
                "words": ["Primary Deficit = Fiscal Deficit - Interest Payments", "Current Fiscal Stance"],
            ...
            },
            {
                ...
                "words": ["CPI (NSO, Services Included, RBI Target 4%)", "WPI (DPIIT, No Services)"],
    ...
    "previous_year_questions": [
        {
            ...
            "options_json": ["Net National Product at Factor Cost (NNP at FC)", "Gross Domestic Product at Market Price (GDP at MP)", "Net Domestic Product at Factor Cost (NDP at FC)", "Gross National Product at Factor Cost (GNP at FC)"],
        ...
        },
        {
            ...
            "options_json": ["Repo Rate", "Reverse Repo Rate", "Bank Rate", "Cash Reserve Ratio"],
        ...
        },
        {
            ...
            "options_json": ["1 January 2015", "15 August 2014", "1 April 2015", "26 January 2015"],
    ...
    "practice_questions": [
        {
            ...
            "options_json": ["GDP - Depreciation", "GNP - Depreciation", "GDP + Net Factor Income from Abroad", "GDP + Subsidies"],
        ...
        },
        {
            ...
            "options_json": ["4% with a tolerance band of ± 2%", "5% with a tolerance band of ± 1%", "3% with a tolerance band of ± 2%", "6% fixed"],
        ...
        },
        {
            ...
            "options_json": ["High inflation combined with high unemployment and stagnant economic growth", "Low inflation with rapid growth", "Falling prices across all sectors", "Zero unemployment with high inflation"],
        ...
        },
        {
            ...
            "options_json": ["Mahalanobis Model", "Harrod-Domar Model", "Gadgil Yojana", "Rao-Manmohan Model"],
        ...
        },
        {
            ...
            "options_json": ["Interest Payments", "Subsidies", "Disinvestment receipts", "Tax revenues"],
        ...
        },
        {
            ...
            "options_json": ["Prime Minister of India", "Finance Minister", "President of India", "Governor of RBI"],
        ...
        },
        {
            ...
            "options_json": ["2012", "2011-12", "2004-05", "2015"],
            "correct_answer": "2012",
        ...
        },
        {
            ...
            "options_json": ["Gresham's Law", "Say's Law", "Okun's Law", "Engel's Law"],
        ...
        },
        {
            ...
            "options_json": ["A specified percentage in cash without interest earnings", "A percentage in gold", "A percentage in government bonds", "Zero percentage"],
        ...
        },
        {
            ...
            "options_json": ["Laffer Curve", "Phillips Curve", "Lorenz Curve", "Kuznets Curve"],
    ...
    "quiz_questions": [
        {
            ...
            "options_json": ["Sir Osborne Smith", "C.D. Deshmukh", "Sir James Braid Taylor", "Dr. Manmohan Singh"],
        ...
        },
        {
            ...
            "options_json": ["Income or wealth inequality distribution", "Inflation vs unemployment", "Tax rates vs tax revenue", "Demand vs supply"],
        ...
        },
        {
            ...
            "options_json": ["Services Sector (Tertiary)", "Agriculture (Primary)", "Manufacturing (Secondary)", "Mining"],
        ...
        },
        {
            ...
            "options_json": ["1969", "1980", "1955", "1975"],
            "correct_answer": "1969",
        ...
        },
        {
            ...
            "options_json": ["Growth rate of Real GDP", "Growth rate of Nominal GDP", "Foreign exchange reserves", "Gold reserves"],
        ...
        },
        {
            ...
            "options_json": ["Volatile food and energy components", "Manufacturing goods", "Services", "Transport equipment"],
        ...
        },
        {
            ...
            "options_json": ["Corporate Tax", "Goods and Services Tax (GST)", "Customs Duty", "Excise Duty"],
        ...
        },
        {
            ...
            "options_json": ["Cost-Push Inflation", "Demand-Pull Inflation", "Deflation", "Disinflation"],
        ...
        },
        {
            ...
            "options_json": ["National Statistical Office (NSO)", "Reserve Bank of India", "NITI Aayog", "Ministry of Finance"],
        ...
        },
        {
            ...
            "options_json": ["Harrod-Domar Model", "Mahalanobis Model", "Feldman Model", "Solow-Swan Model"],
        ...
        "rules": [
            {
                ...
                "words": ["Tehri = Highest (Bhagirathi)", "Hirakud = Longest (Mahanadi)", "Bhakra = Gravity (Sutlej)"],
            ...
            },
            {
                ...
                "words": ["8 Classical Dances", "Kerala has Two (Kathakali & Mohiniyattam)", "Sattriya (Assam)"],
            ...
            },
            {
                ...
                "words": ["Khangchendzonga National Park (Sikkim)", "Only Mixed UNESCO Site in India"],
            ...
            },
            {
                ...
                "words": ["Keibul Lamjao (Manipur)", "Loktak Lake", "Phumdis", "Sangai Deer"],
            ...
            },
            {
                ...
                "words": ["Jim Corbett (Oldest, 1936, Uttarakhand)", "Hemis (Largest, 4400 km², Ladakh)"],
    ...
    "previous_year_questions": [
        {
            ...
            "options_json": ["Keibul Lamjao National Park (Manipur)", "Kaziranga National Park (Assam)", "Sundarbans National Park (West Bengal)", "Namdapha National Park (Arunachal Pradesh)"],
        ...
        },
        {
            ...
            "options_json": ["Assam", "Manipur", "Odisha", "West Bengal"],
        ...
        },
        {
            ...
            "options_json": ["Mahanadi River", "Godavari River", "Bhagirathi River", "Narmada River"],
    ...
    "practice_questions": [
        {
            ...
            "options_json": ["Tehri Dam", "Hirakud Dam", "Bhakra Dam", "Sardar Sarovar Dam"],
        ...
        },
        {
            ...
            "options_json": ["Kerala (Kathakali and Mohiniyattam)", "Tamil Nadu", "Odisha", "Andhra Pradesh"],
        ...
        },
        {
            ...
            "options_json": ["Jim Corbett National Park", "Kaziranga National Park", "Kanha National Park", "Gir National Park"],
        ...
        },
        {
            ...
            "options_json": ["Khangchendzonga National Park", "Manas Wildlife Sanctuary", "Sundarbans National Park", "Western Ghats"],
        ...
        },
        {
            ...
            "options_json": ["Tarapur (Maharashtra)", "Kudankulam (Tamil Nadu)", "Narora (Uttar Pradesh)", "Rawatbhata (Rajasthan)"],
        ...
        },
        {
            ...
            "options_json": ["Asiatic Lion", "Royal Bengal Tiger", "One-horned Rhinoceros", "Snow Leopard"],
        ...
        },
        {
            ...
            "options_json": ["Odisha", "Andhra Pradesh", "Karnataka", "Tamil Nadu"],
        ...
        },
        {
            ...
            "options_json": ["Bharatanatyam", "Kathakali", "Kuchipudi", "Odissi"],
        ...
        },
        {
            ...
            "options_json": ["Narmada River", "Tapi River", "Sabarmati River", "Mahi River"],
        ...
        },
        {
            ...
            "options_json": ["Ladakh", "Himachal Pradesh", "Jammu and Kashmir", "Uttarakhand"],
    ...
    "quiz_questions": [
        {
            ...
            "options_json": ["Kaziranga National Park", "Manas National Park", "Jim Corbett National Park", "Ranthambore National Park"],
        ...
        },
        {
            ...
            "options_json": ["Kathak", "Kathakali", "Bharatanatyam", "Sattriya"],
        ...
        },
        {
            ...
            "options_json": ["Kudankulam Nuclear Power Plant", "Tarapur Atomic Power Station", "Kaiga Generating Station", "Narora Atomic Power Station"],
        ...
        },
        {
            ...
            "options_json": ["Andhra Pradesh and Telangana border", "Karnataka", "Tamil Nadu", "Maharashtra"],
        ...
        },
        {
            ...
            "options_json": ["1973", "1972", "1980", "1986"],
            "correct_answer": "1973",
        ...
        },
        {
            ...
            "options_json": ["Andhra Pradesh", "Karnataka", "Kerala", "Tamil Nadu"],
        ...
        },
        {
            ...
            "options_json": ["Rabindranath Tagore", "Swami Vivekananda", "Raja Ram Mohan Roy", "Aurobindo Ghose"],
        ...
        },
        {
            ...
            "options_json": ["Sutlej River", "Beas River", "Ravi River", "Chenab River"],
        ...
        },
        {
            ...
            "options_json": ["Assam", "Meghalaya", "Tripura", "Nagaland"],
            "correct_answer": "Assam",
        ...
        },
        {
            ...
            "options_json": ["Rajasthan", "Madhya Pradesh", "Gujarat", "Maharashtra"],
        ...
        "rules": [
            {
                ...
                "words": ["1954 Triad", "C. Rajagopalachari", "Dr. S. Radhakrishnan", "Dr. C.V. Raman"],
            ...
            },
            {
                ...
                "words": ["PVC > MVC > VrC (Wartime)", "Ashok > Kirti > Shaurya (Peacetime)"],
            ...
            },
            {
                ...
                "words": ["Khan Abdul Ghaffar Khan (1987)", "Nelson Mandela (1990)", "Two Foreigners"],
            ...
            },
            {
                ...
                "words": ["Tagore (1913)", "Raman (1930)", "Teresa (1979)", "Amartya Sen (1998)", "Satyarthi (2014)"],
            ...
            },
            {
                ...
                "words": ["Jnanpith (1965)", "G. Sankara Kurup (Malayalam)", "Ashapurna Devi (1976, Bengali)"],
    ...
    "previous_year_questions": [
        {
            ...
            "options_json": ["Major Somnath Sharma", "Captain Vikram Batra", "Subedar Major Bana Singh", "Company Havildar Major Abdul Hamid"],
        ...
        },
        {
            ...
            "options_json": ["Gitanjali", "Gora", "Ghare Baire (The Home and the World)", "Chokher Bali"],
        ...
        },
        {
            ...
            "options_json": ["Devika Rani", "Prithviraj Kapoor", "Raj Kapoor", "Lata Mangeshkar"],
    ...
    "practice_questions": [
        {
            ...
            "options_json": ["1954", "1950", "1947", "1952"],
            "correct_answer": "1954",
        ...
        },
        {
            ...
            "options_json": ["Khan Abdul Ghaffar Khan", "Nelson Mandela", "Mother Teresa", "Martin Luther King Jr."],
        ...
        },
        {
            ...
            "options_json": ["Ashok Chakra", "Param Vir Chakra", "Kirti Chakra", "Shaurya Chakra"],
        ...
        },
        {
            ...
            "options_json": ["Amartya Sen", "Abhijit Banerjee", "Manmohan Singh", "Jagdish Bhagwati"],
        ...
        },
        {
            ...
            "options_json": ["G. Sankara Kurup", "K.V. Puttappa", "Uma Shankar Joshi", "Sumitranandan Pant"],
        ...
        },
        {
            ...
            "options_json": ["Sachin Tendulkar", "Major Dhyan Chand", "Viswanathan Anand", "Kapil Dev"],
        ...
        },
        {
            ...
            "options_json": ["Ramon Magsaysay Award", "Booker Prize", "Jnanpith Award", "Gandhi Peace Prize"],
        ...
        },
        {
            ...
            "options_json": ["Ashapurna Devi", "Mahadevi Varma", "Amrita Pritam", "Mahasweta Devi"],
        ...
        },
        {
            ...
            "options_json": ["Scattering of light (Raman Effect)", "Photoelectric effect", "Nuclear magnetic resonance", "Laser physics"],
        ...
        },
        {
            ...
            "options_json": ["Science and Technology", "Literature", "Classical Music", "Cinema"],
    ...
    "quiz_questions": [
        {
            ...
            "options_json": ["3 (Padma Vibhushan, Padma Bhushan, Padma Shri)", "4", "2", "5"],
        ...
        },
        {
            ...
            "options_json": ["Viswanathan Anand", "Geet Sethi", "Sachin Tendulkar", "Karnam Malleswari"],
        ...
        },
        {
            ...
            "options_json": ["Nobel Peace Prize", "Nobel Prize in Literature", "Nobel Prize in Physics", "Nobel Prize in Physiology or Medicine"],
        ...
        },
        {
            ...
            "options_json": ["A peepal leaf with a sunburst embossed on the obverse", "A circular gold coin", "A lotus flower", "An ashoka pillar replica"],
        ...
        },
        {
            ...
            "options_json": ["1979", "1980", "1975", "1982"],
            "correct_answer": "1979",
        ...
        },
        {
            ...
            "options_json": ["K.K. Birla Foundation", "Tata Trust", "Sahitya Akademi", "Bharatiya Jnanpith"],
        ...
        },
        {
            ...
            "options_json": ["Maha Vir Chakra", "Vir Chakra", "Kirti Chakra", "Sena Medal"],
        ...
        },
        {
            ...
            "options_json": ["Hindi ('Ret Samadhi')", "Bengali", "Marathi", "Urdu"],
        ...
        },
        {
            ...
            "options_json": ["Outstanding coaches in sports and games", "Athletes with lifetime performance", "Young aspiring athletes", "University sports champions"],
        ...
        },
        {
            ...
            "options_json": ["Arundhati Roy ('The God of Small Things')", "Kiran Desai ('The Inheritance of Loss')", "Jhumpa Lahiri", "Anita Desai"],
...
with open("scratch/ga_part2.py", "w", encoding="utf-8") as f:
    f.write("# ga_part2.py\n")
    f.write("GA_PART2_DATA = " + json.dumps(ga_part2, indent=4) + "\n")

print("Successfully written scratch/ga_part2.py with Topics 56 to 58!")
